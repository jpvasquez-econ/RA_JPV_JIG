...
2. `0-Raw_Data/Fips/state_codes.txt`
3. `1-Intermediate_Processed_Data/country_coordinates.dta`
...
state_codes <- read_delim("0-Raw_Data/Fips/state_codes.txt", "-", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
```
...
# Adding missing state(DC) in "state_codes"

state_codes <- rbind(state_codes, c("District of Columbia", "DC"))

# Selecting the variables of interest

us_counties <- us_counties %>% 
  transmute(region = state_codes$X1[match(state, state_codes$X2)], subregion = county, subregion_population = population_2010, latitude, longitude)
