...
libs <- c("dplyr", "tidyr", "styler", "lintr", "readr", "janitor", "ggplot2")
...
The datasets are joined by the "state_seller" and "state_buyer" variables and the "n" and "share" variables are kept. Also, a the data is sorted to comply with the plot structure. This is accomplished by creating the variable "xpp" which is a sequence from 1 to 400.
